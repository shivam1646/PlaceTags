...
const Map = ({ classes }) => {
  ...
  const highlightNewPin = pin => {
    const isNewPin = differnceInMinutes(Date.now(), Number(pin.createdAt)) <= 30;
  ...
  return (
    <div className={mobileSize ? classes.rootMobile : classes.root}>
      <ReactMapGL
        mapboxApiAccessToken = "pk.eyJ1Ijoic2hpdmFtMTYiLCJhIjoiY2txbzQ3ZjA3MGE0ZjJucndjbzN4MnphYiJ9.-tEZLWBvpqx7UpRGdvKKFA"
        width="100vw"
